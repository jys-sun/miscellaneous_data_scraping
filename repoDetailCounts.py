...
def scrapingForDetailCounts(threadName,tokens,inputSpreadsheet,outputSpeadsheet):
    ...
    detailList ={"SearchKeyword":[],"IsOrgRepo":[],"OwnerName":[],"RepoName":[],"RepoSlug":[],"Language":[],"StarsCount":[],"ForksCount":[],
                "Description":[],"CreatedAt":[],"PushedAt":[],"IsFork":[],'Topics':[],'MergedPullRequestsCount':[],'ContributorsCount':[]}
...
if __name__ == '__main__':
    ...
    threads = []
    t1 = threading.Thread(target=scrapingForDetailCounts,args=("thread1",myGithubTokens, r'C:\\Users\\myAccount\\Desktop\\inputsheet_01.xlsx',r'C:\\Users\\myAccount\\Desktop\\OutputSpreadsheet_01.xlsx'))
    t2 = threading.Thread(target=scrapingForDetailCounts,args=("thread2",myGithubTokens, r'C:\\Users\\myAccount\\Desktop\\inputsheet_02.xlsx',r'C:\\Users\\myAccount\\Desktop\\OutputSpreadsheet_02.xlsx'))
    threads.append(t1)
    threads.append(t2)
