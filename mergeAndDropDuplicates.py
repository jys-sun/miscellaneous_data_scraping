...
if __name__ == '__main__':
    ...
    dirToMerge = r'C:\\Users\\myAccount\\Desktop\\FolderToMerge' 
    #setting the path and file name for the output merge result
    outputFilePath='C:\\Users\\myAccount\\Desktop\\MergedFile.xlsx'
